...
<div class="container">
    <div class="row">
        <div class="col-lg-6">
            <f:form modelAttribute="product-edit" action="/update-product" method="post">
...
<%--                            <f:options value="${item.categoryId}">${item.categoryName}</f:options>--%>
<%--                        </c:forEach>--%>
                        <f:options items="${listCategory}" itemLabel="categoryName" itemValue="categoryId" />
                ...
                <div class="form-group">
                    ...
                    <input type="file" src="" alt="" name="img_upload" multiple>
